...
Udělat svou první výstavu je nejtěžší a moc si vážíme toho, že jste se rozhodli použít náš nástroj. Abychom vám tento proces zjednodušili, připravili jsme pro vás sadu pracovních listů, které vám pomohou vytvořit scénář virtuální výstavy. Jednoduše si je vytiskněte. Pracovní listy vám pomohou s cílením na konkrétní typy online návštěvníků a pomocí otázek napomohou zpřesnění obsahu a výběru multimédií. 
